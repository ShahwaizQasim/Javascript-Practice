...
// 1. Shallow Copy:
// Shallow copy ka matlab hai ki object ka ek new copy banaya jata hai, lekin jo nested objects ya arrays hain
// unko reference ke saath copy kiya jata hai. Iska matlab hai ki agar nested objects ya arrays ko modify 
// kiya jaye, to wo changes original object me bhi reflect honge.

const copy1Obj = { ...originalObj }; // humne original-oject ko clone kiya hai
copy1Obj.address.city = "Lahore";

console.log("shallowCopy" ,copy1Obj); 
console.log("orignalObject" ,originalObj); // original object me changes hongi
...
// jisme har nested object ka apna naya copy ban jata hai, aur original object ke saath koi reference link nahi
// rehta. Agar aap deep copy karte hain to nested objects ke changes original object ko effect nahi karte.
