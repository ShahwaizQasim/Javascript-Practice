...
let myTime3 = dateFns.format(
  new Date(2024, 3, 20, 3, 45),
  "yyy-MM-dd H:mm EEEE"
);

let myTime4 = dateFns.format(
  new Date(2024, 3, 20, 13, 45, 30),
  "MMMM do, yyy hh.mm.ss a"
);

let myTime5 = dateFns.format(
  new Date(2024, 3, 20, 13, 45),
  "dd MMMM yyy 'at' hh:mm a"
);

let time =  dateFns.formatDistance(
