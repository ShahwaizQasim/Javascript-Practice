...
let myArray = ["Yawar","Ali","Ahmed","Saad","Yawar","Ali","Ali"];
...
//let returnvalue1 = myArray.indexOf("Saad") // ye array ki index maloom krne ky liye use hota hai
...
// const monthsSplice = months.splice(1,1,"Feb","March");  //splice me hum value remove bi kr sakte hain or add bi kr sakte hain 
// const monthsSplice2 = months.splice(4,0,"May"); 
// console.log(months);
